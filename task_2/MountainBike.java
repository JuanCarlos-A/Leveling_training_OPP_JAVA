...
public class MountainBike{
    ...
    public MountainBike(String placa,byte numRuedas,boolean suspension, String color, boolean electrico, double precio) {
        this.placa = placa;
    ...
    public void getInformation(){
        System.out.println("La placa de la bicicleta de montaña es "+ placa);
